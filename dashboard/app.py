...
@st.cache_resource
def load_models():
    vel_model, device = load_model("dashboard/models/terraflow-5.5M.pth")
    temp_model, temp_scaler = load_model_and_scaler("dashboard/models/best_tempflow_model1.keras", "dashboard/models/scaler_tempflow1.save")
